...
%global crate cosmic-osk
%global build_rustflags %{?build_rustflags} --cfg=io_uring_skip_arch_check

# cosmic-packaging: Nightly build processed from tagged version at https://src.fedoraproject.org/rpms/cosmic-osk.git
%global commit aa38892cd56ecace7ed608acb12fa275949d56c1
%global shortcommit %{sub %{commit} 1 7}
%global commitdatestring 2026-09-04 14:19:09 -0600
%global commitdate 20260904
%global builddate 202609051335
%global cosmic_minver 1.7.0

Name:           cosmic-osk
Version: 1.7.0^git%{commitdate}.%{shortcommit}
Release:        %autorelease
...
Source0:        https://github.com/pop-os/cosmic-osk/archive/%{commit}/cosmic-osk-%{shortcommit}.tar.gz
# To create the below sources:
# * git clone https://github.com/pop-os/cosmic-osk at the specified commit
